      ...
      <g>
        <defs>
          <linearGradient
            ...
            y2="58.975%"
          >
            <stop offset="0%" stopColor="#8AC443"></stop>
            <stop offset="100%" stopColor="#75B843"></stop>
          </linearGradient>
          <linearGradient
            id="linearGradient-2"
            x1="-10.801%"
            ...
            y2="56.986%"
          >
            <stop offset="0%" stopColor="#75B843"></stop>
            <stop offset="100%" stopColor="#4B9744"></stop>
          </linearGradient>
          <linearGradient
            id="linearGradient-3"
            x1="108.51%"
            ...
            y2="65.747%"
          >
            <stop offset="0%" stopColor="#C1DB74"></stop>
            <stop offset="100%" stopColor="#ACD259"></stop>
          </linearGradient>
          <linearGradient
            id="linearGradient-4"
            x1="129.073%"
            ...
            y2="61.919%"
          >
            <stop offset="0%" stopColor="#ACD259"></stop>
            <stop offset="100%" stopColor="#8AC443"></stop>
          </linearGradient>
        </defs>
        <path
          fill="#70706F"
        ...
        <path
          ...
          d="M378.1 56.6l37 55.2-1.7 1.9-35.3-57.1z"
        ></path>
        <path
          fill="#3D3D3C"
